...
$(MODULE)_DEP_LIB     := $(addsuffix .a, $(addprefix $(PRJ_ROOT)/lib/,$($(MODULE)_DEP_LIB)))
$(MODULE)_DEP_LIB     := $(addprefix -l, $($(MODULE)_DEP_LIB))
...
$($(MODULE)_TARGET): LOCAL_DEP_LIB   := $($(MODULE)_DEP_LIB)
$($(MODULE)_TARGET): LOCAL_OTHER_LIB := $($(MODULE)_LINK_LIB)
...
$($(MODULE)_TARGET): $($(MODULE)_OBJ)
	...
	$(LINKER) $(LDFLAGS) $^ -o $@ $(LOCAL_DEP_LIB) $(LOCAL_OTHER_LIB)
	@echo; tput setaf 0
